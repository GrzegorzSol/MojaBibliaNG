...
__published:	// IDE-managed Components
	...
	TPanel *PanelSetupsOthers;
	TGroupBox *GroupBoxSizeDisplay;
	...
	TGroupBox *GroupBoxSetupStartDisplayTranslate;
	TListBox *ListBoxSelestDefaultDisplay;
